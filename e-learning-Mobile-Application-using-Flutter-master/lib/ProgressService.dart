...
class ProgressService {
  ...
  final String baseUrl = "http://192.168.1.13:3000/api/progress"; // For local testing: "http://localhost:3000"
  ...
  Future<void> updateProgress(String courseName, String studentId, int progressPercentage) async {
    final response = await http.post(
