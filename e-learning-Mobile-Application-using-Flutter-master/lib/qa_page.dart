  ...
  final List<Map<String, String>> faqList = [
    {
      ...
      "answer": "UI refers to User Interface, which focuses on how the user interacts with the product. UX refers to User Experience, which focuses on the overall experience the user has when using the product."
    },
    {
      "question": "How do I get started with this course?",
      "answer": "You can get started by enrolling in the course and completing the modules one by one. Each module consists of videos, quizzes, and hands-on exercises."
    },
    {
      "question": "Are there any prerequisites for this course?",
      "answer": "There are no specific prerequisites. However, a basic understanding of design principles and user behavior will be helpful."
    },
  ];
